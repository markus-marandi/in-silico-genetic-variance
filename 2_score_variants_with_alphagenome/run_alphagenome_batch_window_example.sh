...
# add here line to cd to the dir where this script is located

# use env python directly, avoid activation
ENV_DIR=/ # TODO: add here the path of your conda environment
...
# now load .env and normalize api key var name
...
PYTHONUNBUFFERED=1 "${PYTHON}" # add here the path to the script you want to run
