...
#SBATCH -c 2
#SBATCH --mem=128000M
#SBATCH --output=alphagenome_background_NULL_results_%j.out
#SBATCH --error=alphagenome_background_NULL_results_%j.err
...
"${PYTHON}" pipeline_runner.py \
  --chunks-dir /cfs/klemming/scratch/m/mmarandi/experiments/dataset5/background_NULL/02_chunks/chunks \
  --gene-list /cfs/klemming/scratch/m/mmarandi/experiments/dataset4/background/01_inputs/background_gene_set_380.tsv
