...
def aggregate_genes(
    ...
    # 6. Pre-calculate columns (Distances, Abs Score, VG Contribution)
    lf = lf.with_columns(
    ...
    # 7. Define Aggregations (Comprehensive List)
    agg_exprs = [
        # --- Basic Counts & VG ---
        ...
        # Note: arg_min/max not always available in Lazy agg, using sort_by
    ...
    # 9. Enrich with Metadata (Lazy Join)
    ...
    # 10. Post-Aggregation Calculations (Ratios & Fractions)
    # We do this here because we need the aggregated columns (e.g. genomic_length)
